...
module.exports = async function(deployer, network, accounts) {
  ...
  await deployer.deploy(Registry).then(function() {
    console.log(
      `Smart Contract "Registry.Sol" has been deployed at ETH address: ${Registry.address}`
    );
    return;
  });
  ...
  const secretConfig = {
    ...
    fn: `construct(address)`,
    args: [[Registry.address, "address"]],
    gasLimit: 2000000,
